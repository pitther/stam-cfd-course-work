...
class Fluid {
    constructor(N, visc, diff) {
        ...
        this.v0 = new Float32Array((N) * (N));
        this.x = new Float32Array((N) * (N));
        this.x0 = new Float32Array((N) * (N));
...
const useStemFluid = ({SIZE, visc, diff}) => {
    SOLID_OBJECTS = new Array((SIZE) * (SIZE)).fill(false);
    /*SOLID_OBJECTS = [
        false,
        false,
        false,
    ...
    const removeSolidObject = (x, y) => {
        SOLID_OBJECTS[IX(SIZE, x, y)] = false;
    }
